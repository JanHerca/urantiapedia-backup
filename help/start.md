...
For more information on the content check here: [Content](/en/help/content.md)
...
Currently the project is in preparation stage for english and spanish languages. To know more about the current progress of the project check here: [Status](/en/help/status.md)

In short, user profiles are as follows:
- **Administrators**, the only users that can do changes to [Urantiapedia](https://urantiapedia.site) in preparation stage. Check more in [Admin help](/en/help/admin.md).
- **Developers**, users that add changes to the app called *Urantiapedia Tools*, located in the `app` folder of this Github project. Check [Dev help](/en/help/devs.md)
- **Github editors**, users that can add changes to content in preparation stage. This content is located in `input` folder of this Github project. Check [Github editors help](/en/help/github.md)
- **Editors**, users that are correctly validated and can add changes in the public stage. Check [Editors help](/en/help/editors.md).
